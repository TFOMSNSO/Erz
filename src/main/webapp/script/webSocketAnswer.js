...
*/    }
    ...
    if(polucheno == "> получен" )
    {
    	...
    	if(event.data.indexOf('zp1') + 1) {
    		if(event.data.indexOf('zp1fiodtable') + 1){
    			kluch = 'zp1fiodtable';
			}else{
    			kluch = 'zp1';
    		}
    	...
    	if(event.data.indexOf('A03P07other') + 1) {kluch = 'A03P07other';}
    	if(event.data.indexOf('otherzp9') + 1){kluch = 'otherzp9';}
