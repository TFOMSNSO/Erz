...
//								 //оставляем енп
    ...
    private String findDate(String enp){
        ...
        try {
            ...
            resultSet = statement.executeQuery("select trunc(date_vosstanovl) from WW_PRIZYV w where w.enp_vnutr =" + enp + " or w.enp = " + enp);
            ...
            System.out.println("enp:" + enp + " date_otrkep:" + d);
